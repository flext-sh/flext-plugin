...
# Plugin Name Fields
PluginNameField = Annotated[str, Field(
    ...,
...
OptionalPluginNameField = Annotated[str, Field(
    default="",
    min_length=0,
    max_length=MAX_PLUGIN_NAME_LENGTH,
...
# Version Fields
PluginVersionField = Annotated[str, Field(
    default="1.0.0",
...
# Description Fields
PluginDescriptionField = Annotated[str, Field(
    default="",
    max_length=500,
    description="Plugin description",
    examples=["A data extraction plugin", "Authentication service plugin"])]

PluginLongDescriptionField = Annotated[str, Field(
    default="",
    max_length=2000,
    description="Detailed plugin description")]

# Author Fields
PluginAuthorField = Annotated[str, Field(
    default="",
    max_length=100,
...
# URL Fields
PluginUrlField = Annotated[str | None, Field(
    default=None,
    pattern=r"^https?://[^\s]+$",
...
PluginConfigField = Annotated[dict[str, PluginConfigData], Field(
    default_factory=dict,
    description="Plugin-specific configuration dictionary")]

PluginRuntimeDataField = Annotated[dict[str, PluginConfigData], Field(
    default_factory=dict,
    description="Runtime-specific data dictionary")]

# List Fields
PluginTagsField = Annotated[list[str], Field(
...
PluginDependenciesField = Annotated[list[str], Field(
    default_factory=list,
    max_length=50,
...
PluginKeywordsField = Annotated[list[str], Field(
    default_factory=list,
    max_length=30,
...
PluginMaintainersField = Annotated[list[str], Field(
    default_factory=list,
    max_length=10,
...
PluginErrorsField = Annotated[list[str], Field(
    default_factory=list,
    description="List of error messages")]

PluginsAffectedField = Annotated[list[str], Field(
    default_factory=list,
    description="List of affected plugin names")]

# Boolean Fields
PluginEnabledField = Annotated[bool, Field(
    default=True,
    description="Whether the plugin is enabled")]

PluginAutoStartField = Annotated[bool, Field(
    default=False,
    description="Whether to automatically start the plugin")]

PluginSuccessField = Annotated[bool, Field(
    default=False,
    description="Whether operation/execution succeeded")]

# Numeric Fields
PluginTimeoutField = Annotated[int, Field(
    default=DEFAULT_PLUGIN_TIMEOUT_SECONDS,
    ge=1,
    le=3600,
    description="Timeout in seconds (1-3600)")]

PluginExecutionTimeField = Annotated[float, Field(
    default=0.0,
    ge=0.0,
    description="Execution time in seconds")]

PluginExecutionTimeMsField = Annotated[float, Field(
    default=0.0,
    ge=0.0,
    description="Execution time in milliseconds")]

# Identifier Fields
PluginIdField = Annotated[str, Field(
    ...,
    min_length=1,
    max_length=100,
    description="Unique plugin identifier")]

ExecutionIdField = Annotated[str, Field(
    ...,
    min_length=1,
    max_length=100,
    description="Unique execution identifier")]

OperationNameField = Annotated[str, Field(
    ...,
    min_length=1,
    max_length=50,
...
UpdatedAtField = Annotated[datetime | None, Field(
    default=None,
    description="Last update timestamp")]

StartedAtField = Annotated[datetime, Field(
    default_factory=datetime.now,
    description="Start timestamp")]

CompletedAtField = Annotated[datetime, Field(
    default_factory=datetime.now,
    description="Completion timestamp")]

# Data Fields
InputDataField = Annotated[dict[str, PluginConfigData], Field(
    default_factory=dict,
    description="Input data dictionary")]

OutputDataField = Annotated[PluginConfigData, Field(
    default=None,
    description="Output data from execution")]

ContextDataField = Annotated[dict[str, PluginConfigData], Field(
    default_factory=dict,
    description="Context data dictionary")]

DetailsDataField = Annotated[dict[str, PluginConfigData], Field(
    default_factory=dict,
    description="Additional details dictionary")]

# Error Fields
ErrorMessageField = Annotated[str, Field(
    default="",
    max_length=1000,
    description="Error message")]

# License Field
PluginLicenseField = Annotated[str | None, Field(
    default=None,
    max_length=50,
...
PlatformVersionField = Annotated[str | None, Field(
    default=None,
    pattern=r"^\d+\.\d+\.\d+(?:-[a-zA-Z0-9]+)?$",
    description="Required platform version",
    examples=["1.0.0", "2.1.3"])]

PythonVersionField = Annotated[str | None, Field(
    default=None,
    pattern=r"^[>=<~!^]*\d+\.\d+(?:\.\d+)?$",
