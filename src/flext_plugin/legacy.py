...
def create_plugin(name: str, version: str) -> FlextPluginEntity:
    ...
    deprecation_warning("create_plugin", "create_flext_plugin")
...
def create_plugin_config(
    ...
    deprecation_warning("create_plugin_config", "create_flext_plugin_config")
...
def create_plugin_registry(
    ...
    deprecation_warning("create_plugin_registry", "create_flext_plugin_registry")
...
def create_plugin_metadata(
    ...
    deprecation_warning("create_plugin_metadata", "create_flext_plugin_metadata")
...
def plugin_error(message: str) -> FlextPluginError:
    ...
    deprecation_warning("plugin_error", "FlextPluginError")
...
def plugin_discovery_error(message: str) -> FlextPluginDiscoveryError:
    ...
    deprecation_warning("plugin_discovery_error", "FlextPluginDiscoveryError")
...
def plugin_loading_error(message: str) -> FlextPluginLoadingError:
    ...
    deprecation_warning("plugin_loading_error", "FlextPluginLoadingError")
...
def plugin_execution_error(message: str) -> FlextPluginExecutionError:
    ...
    deprecation_warning("plugin_execution_error", "FlextPluginExecutionError")
...
def plugin_configuration_error(message: str) -> FlextPluginConfigurationError:
    ...
    deprecation_warning("plugin_configuration_error", "FlextPluginConfigurationError")
...
def plugin_validation_error(message: str) -> FlextPluginValidationError:
    ...
    deprecation_warning("plugin_validation_error", "FlextPluginValidationError")
...
def plugin_lifecycle_error(message: str) -> FlextPluginLifecycleError:
    ...
    deprecation_warning("plugin_lifecycle_error", "FlextPluginLifecycleError")
...
def plugin_registry_error(message: str) -> FlextPluginRegistryError:
    ...
    deprecation_warning("plugin_registry_error", "FlextPluginRegistryError")
...
def plugin_hot_reload_error(message: str) -> FlextPluginHotReloadError:
    ...
    deprecation_warning("plugin_hot_reload_error", "FlextPluginHotReloadError")
...
def plugin_security_error(message: str) -> FlextPluginSecurityError:
    ...
    deprecation_warning("plugin_security_error", "FlextPluginSecurityError")
...
def plugin_compatibility_error(message: str) -> FlextPluginCompatibilityError:
    ...
    deprecation_warning("plugin_compatibility_error", "FlextPluginCompatibilityError")
...
def plugin_metadata_error(message: str) -> FlextPluginMetadataError:
    ...
    deprecation_warning("plugin_metadata_error", "FlextPluginMetadataError")
...
def plugin_platform_error(message: str) -> FlextPluginPlatformError:
    ...
    deprecation_warning("plugin_platform_error", "FlextPluginPlatformError")
...
def flext_plugin_manager() -> FlextPluginPlatform:
    """Legacy alias for FlextPluginPlatform."""
    deprecation_warning("flext_plugin_manager", "FlextPluginPlatform")
    return FlextPluginPlatform()


def simple_plugin_manager() -> FlextPluginPlatform:
    """Legacy alias for FlextPluginPlatform."""
    deprecation_warning("simple_plugin_manager", "FlextPluginPlatform")
    return FlextPluginPlatform()
...
def init_plugin_system(
    ...
    """Legacy alias for create_flext_plugin_registry."""
    deprecation_warning("init_plugin_system", "create_flext_plugin_registry")
    return create_flext_plugin_registry(name=name, plugins=plugins)
...
def setup_plugins(
    ...
    """Legacy alias for create_flext_plugin_registry."""
    deprecation_warning("setup_plugins", "create_flext_plugin_registry")
    return create_flext_plugin_registry(name=name, plugins=plugins)
