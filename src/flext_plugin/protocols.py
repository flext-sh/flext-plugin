    ...
    class Plugin:
        ...
        class PluginDiscovery(Protocol):
            ...
            def discover_plugins(
                self,
                paths: list[str],
            ) -> m_core.Result[list[m_core.JsonDict]]:
        ...
        class PluginRegistry(Protocol):
            ...
            def register_plugin(
                self, _plugin: m_core.GeneralValueType
            ) -> m_core.Result[bool]:
                """Register a plugin."""
                ...
            ...
            ) -> m_core.Result[m_core.GeneralValueType | None]:
                """Get a registered plugin by name."""
                ...

            def list_plugins(self) -> m_core.Result[list[m_core.JsonDict]]:
        ...
        class PluginConfiguration(Protocol):
            ...
            def load_config(self, _plugin_name: str) -> m_core.Result[m_core.JsonDict]:
            ...
            def save_config(
                self,
                _plugin_name: str,
                config: m_core.JsonDict,
            ) -> m_core.Result[bool]:
                """Save configuration for a plugin."""
                ...

            def validate_config(self, config: m_core.JsonDict) -> m_core.Result[bool]:
        ...
        class PluginStorage(Protocol):
            ...
            def retrieve_plugin(
                self,
                _plugin_name: str,
            ) -> m_core.Result[m_core.JsonDict | None]:
        ...
        class LoggerProtocol(Protocol):
            ...
            def critical(
                self,
                message: str,
                *args: m_core.GeneralValueType,
                **kwargs: m_core.GeneralValueType,
            ) -> None:
        ...
        class PluginLoaderProtocol(Protocol):
            ...
            def load_plugin(
                self, plugin_path: str | m_core.GeneralValueType
            ) -> m_core.Result[m_core.GeneralValueType]:
        ...
        class PluginRegistryProtocol(Protocol):
            ...
            def register(self, plugin: m_core.GeneralValueType) -> m_core.Result[None]:
                """Register a plugin."""
                ...
        ...
        class DiscoveryStrategyProtocol(Protocol):
            ...
            def discover(
                self,
                paths: list[str],
            ) -> m_core.Result[list[m_core.GeneralValueType]]:
