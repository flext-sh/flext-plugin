"""Plugin manager system for FLX Meltano Enterprise.
...
Usage:
    from flx_core.plugins.manager import PluginManager, PluginConfiguration
...
if TYPE_CHECKING:
    ...
    from flx_core.plugins.types import PluginExecutionResult, PluginType
