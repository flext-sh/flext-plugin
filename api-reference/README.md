...
2. `src/flext_plugin/__init__.py` exports
3. Module docstrings
...
- Primary facades: `FlextPluginAdapters`, `FlextPluginService`, `FlextPluginLoader`, `FlextPluginHotReload`, `FlextPluginImplementations`, `FlextPluginTypes` (+10 more)
