...
```yaml
        1  # Generated by `flext-infra codegen conform` for flext-plugin — DO NOT EDIT.
        2  version: 2
        3  updates:
...
**Classe**: Insecure Configuration · **Local**: `pyproject.toml:616`
...
```toml
      612  all = true
      613  in_place = true
      614  sort_first = ["build-system", "dependency-groups", "project", "tool"]
      615  
>>>   616  [tool.uv]
      617  link-mode = "copy"
      618  
      619  [tool.vulture]
      620  exclude = ["*/_protocols/*"]
```
