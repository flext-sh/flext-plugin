...
| 4 | medium | high | `uv-missing-dependency-cooldown` | `pyproject.toml` | 616 | |
...
Dados brutos: `~/semgrep-violations/by-repo/flext-sh__flext-plugin.json`
