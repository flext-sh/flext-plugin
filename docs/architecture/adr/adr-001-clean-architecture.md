...
**Why Rejected**: Team lacks functional programming experience. Python ecosystem is primarily t.NormalizedValue-oriented. Would require complete paradigm shift.
