...
class TestFlextPluginService:
    ...
    def test_execute_method_fails_as_expected(self, service: FlextPluginService) -> None:
    ...
    def test_discovery_port_property_mock_fallback(self, service: FlextPluginService) -> None:
    ...
    def test_loader_port_property_mock_fallback(self, service: FlextPluginService) -> None:
    ...
    def test_manager_port_property_mock_fallback(self, service: FlextPluginService) -> None:
    ...
    def test_discover_plugins_empty_path_fails(self, service: FlextPluginService) -> None:
        """Test discover_plugins with empty path fails."""
        result = service.discover_plugins("")
        assert not result.is_success
        assert "Path is required" in str(result.error)

    def test_discover_plugins_valid_path_uses_mock(self, service: FlextPluginService) -> None:
        """Test discover_plugins with valid path uses mock port."""
        result = service.discover_plugins("/test/path")
        assert result.is_success
        assert result.data == []

    def test_load_plugin_invalid_plugin_fails(self, service: FlextPluginService) -> None:
    ...
    def test_load_plugin_valid_plugin_uses_ports(self, service: FlextPluginService) -> None:
        """Test load_plugin with valid plugin uses mock ports."""
        plugin = FlextPlugin(name="test-plugin", plugin_type=PluginType.UTILITY, version="1.0.0")
        result = service.load_plugin(plugin)
    ...
    def test_unload_plugin_valid_name_uses_mock(self, service: FlextPluginService) -> None:
    ...
    def test_install_plugin_valid_path_uses_mock(self, service: FlextPluginService) -> None:
    ...
    def test_uninstall_plugin_empty_name_fails(self, service: FlextPluginService) -> None:
        """Test uninstall_plugin with empty name fails."""
        result = service.uninstall_plugin("")
        assert not result.is_success
        assert "Plugin name is required" in str(result.error)

    def test_uninstall_plugin_valid_name_uses_mock(self, service: FlextPluginService) -> None:
    ...
    def test_enable_plugin_valid_name_uses_mock(self, service: FlextPluginService) -> None:
    ...
    def test_disable_plugin_valid_name_uses_mock(self, service: FlextPluginService) -> None:
        """Test disable_plugin with valid name uses mock port."""
        result = service.disable_plugin("test-plugin")
        assert result.is_success

    def test_get_plugin_config_empty_name_fails(self, service: FlextPluginService) -> None:
        """Test get_plugin_config with empty name fails."""
        result = service.get_plugin_config("")
        assert not result.is_success
        assert "Plugin name is required" in str(result.error)

    def test_get_plugin_config_valid_name_uses_mock(self, service: FlextPluginService) -> None:
    ...
    def test_update_plugin_config_empty_name_fails(self, service: FlextPluginService) -> None:
    ...
    def test_update_plugin_config_invalid_config_fails(self, service: FlextPluginService) -> None:
    ...
    def test_update_plugin_config_valid_params_uses_mock(self, service: FlextPluginService) -> None:
        """Test update_plugin_config with valid params uses mock port."""
        config = FlextPluginConfig(plugin_name="test-plugin")
        result = service.update_plugin_config("test-plugin", config)
        assert result.is_success

    def test_is_plugin_loaded_empty_name_fails(self, service: FlextPluginService) -> None:
        """Test is_plugin_loaded with empty name fails."""
        result = service.is_plugin_loaded("")
        assert not result.is_success
        assert "Plugin name is required" in str(result.error)

    def test_is_plugin_loaded_valid_name_uses_mock(self, service: FlextPluginService) -> None:
...
class TestFlextPluginDiscoveryService:
    ...
    def test_discovery_service_inheritance(self, discovery_service: FlextPluginDiscoveryService) -> None:
        """Test discovery service inherits correctly."""
        from flext_core import FlextDomainService
        assert isinstance(discovery_service, FlextDomainService)

    def test_execute_method_fails_as_expected(self, discovery_service: FlextPluginDiscoveryService) -> None:
        """Test execute method returns failure as designed."""
        result = discovery_service.execute()
        assert not result.is_success
        assert "Use specific service methods instead of execute" in str(result.error)

    def test_discovery_port_property_mock_fallback(self, discovery_service: FlextPluginDiscoveryService) -> None:
        """Test discovery_port property returns mock when no port registered."""
    ...
    def test_scan_directory_empty_path_fails(self, discovery_service: FlextPluginDiscoveryService) -> None:
    ...
    def test_scan_directory_valid_path_uses_mock(self, discovery_service: FlextPluginDiscoveryService) -> None:
        """Test scan_directory with valid path uses mock port."""
        result = discovery_service.scan_directory("/test/directory")
        assert result.is_success
        assert result.data == []

    def test_validate_plugin_integrity_none_plugin_fails(self, discovery_service: FlextPluginDiscoveryService) -> None:
    ...
    def test_validate_plugin_integrity_valid_plugin_uses_mock(self, discovery_service: FlextPluginDiscoveryService) -> None:
...
class TestServiceErrorHandling:
    ...
    def test_service_port_properties_return_mock_implementations(self) -> None:
        ...
        assert port1.discover_plugins("test").is_success
        assert port2.discover_plugins("test").is_success
        assert port3.is_plugin_loaded("test").is_success
        assert port4.is_plugin_loaded("test").is_success
        assert port5.uninstall_plugin("test").is_success
        assert port6.uninstall_plugin("test").is_success
    ...
    def test_service_handles_discovery_exceptions(self, mock_discovery_port: Mock) -> None:
    ...
    @patch("flext_plugin.application.services.FlextPluginDiscoveryService.discovery_port")
    def test_discovery_service_handles_scan_exceptions(self, mock_discovery_port: Mock) -> None:
